...
import com.danielschatz.gliderweightbalance.databinding.ItemMassInputBinding
            ...
            if (station.maxMass != null && currentMass > station.maxMass) {
                ...
                binding.massTextInputLayout.setHelperTextColor(
                    android.content.res.ColorStateList.valueOf(
                        binding.root.context.getColor(com.danielschatz.gliderweightbalance.R.color.helper_text_default)
                    )
                )
            }
        }
